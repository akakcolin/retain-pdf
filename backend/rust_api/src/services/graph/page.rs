...
use crate::models::api::{
    EntityPageCitation, EntityPageEvidence, EntityPageRecord, EntityPageView, EntityRecord,
    RelatedEntity,
};
...
pub async fn generate_entity_page<C: Chat>(
    ...
    Ok(page_view(&entity, Some(record), &evidence_sig))
}
...
pub fn get_entity_page(deps: &GraphDeps<'_>, entity_id: &str) -> Result<EntityPageView, AppError> {
    ...
    Ok(page_view(&entity, page, &current_sig))
}
