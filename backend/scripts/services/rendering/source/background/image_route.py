...
from services.rendering.source.background.extract import image_prefers_solid_fill
from services.rendering.source.background.extract import raw_stream_image_meta
from services.rendering.source.background.patch import merge_close_vertical_rects
