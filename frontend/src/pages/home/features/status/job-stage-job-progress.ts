...
import type { JobLike, JobPayload } from "./external.js";
...
export function jobProgress(job: JobLike | JobPayload = {}) {
...
export function stageFallbackProgress(_stageKey: string, _job: JobLike | JobPayload = {}) {
  return null;
}

export interface PreferJobProgressOptions {
  currentEventRecord?: Pick<
    StageEventRecord,
    "hasCanonicalEventContract" | "isMainLane" | "canonicalDisplayStage"
  > | null;
}

export function shouldPreferJobProgress(
  job: JobLike | JobPayload | null | undefined,
  stageKey: string,
  latestProgress: ProgressRecord | null | undefined,
  {
    currentEventRecord = null,
  }: PreferJobProgressOptions = {},
) {
...
export function jobProgressRecord(
  job: JobLike | JobPayload | null | undefined,
  stageKey: string,
): ProgressRecord | null {
