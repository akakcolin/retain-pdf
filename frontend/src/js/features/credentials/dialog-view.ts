...
export function browserCredentialElements() {
  return {
    ...
    chatModelApiKeyInput: $(BROWSER_CREDENTIAL_IDS.chatModelApiKey) as HTMLInputElement | null,
    chatModelBaseUrlInput: $(BROWSER_CREDENTIAL_IDS.chatModelBaseUrl) as HTMLInputElement | null,
    chatModelNameInput: $(BROWSER_CREDENTIAL_IDS.chatModelName) as HTMLInputElement | null,
